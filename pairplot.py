...
class Pairplot(object):
    ...
    def __init__(self, url:str):
        '''
        Initializes the Pairplot object by opening the logo file, retrieving the analysis worksheet and signals, and building the GUI widgets
        ...
        self.avail_signals = self.worksheet.display_items
